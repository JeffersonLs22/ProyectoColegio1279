...
public class ProfesoresPrimerGradoA extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProfesoresPrimerGradoA frame = new ProfesoresPrimerGradoA();
	...
	public ProfesoresPrimerGradoA() {
		...
		JLabel lblNewLabel = new JLabel("Alumnos Del Primer Grado");
			...
			public void mouseClicked(MouseEvent e) {
				...
				try {
					...
					ps = con.prepareStatement(
							"SELECT Nombre,Apellido,Nota1,Nota2,Nota3,Nota4,Promedio FROM AlumnosDelPrimerGradoA WHERE id = ? ");
					ps.setInt(1, id);
					rs = ps.executeQuery();
	...
	private void Modificar() {
		...
		try {
			...
			// INSERTA LOS
			// DATOS--------------------------------------------------------------------------------------------------------------------------------------------
			PreparedStatement ps = con.prepareStatement("UPDATE AlumnosDelPrimerGradoA SET Nombre=?, Apellido=?,Nota1=? ,Nota2=? ,Nota3=? ,Nota4=? ,Promedio=? WHERE id=?");
	...
	private void Guardar() {
		...
		try {
			...
			PreparedStatement ps = con.prepareStatement(
					"INSERT INTO AlumnosDelPrimerGradoA(Nombre, Apellido,Nota1 ,Nota2 ,Nota3 ,Nota4 ,Promedio) VALUES (?,?,?,?,?,?,?)");
	...
	private void CargarTabla() {
		...
		try {
			Connection con = Conexcion.getConexcion();
			ps = con.prepareStatement(
					"SELECT id,Nombre,Apellido,Nota1,Nota2,Nota3,Nota4,Promedio FROM AlumnosDelPrimerGradoA");
